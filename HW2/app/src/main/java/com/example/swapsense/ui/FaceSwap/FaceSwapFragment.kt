...
class FaceSwapFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        saveImageButton = binding.buttonSaveImage
...
//                                saveImageButton.visibility = Button.VISIBLE
                            } else {
                                addImageButton.visibility = Button.VISIBLE
//                                saveImageButton.visibility = Button.GONE
                            }
...
//                requestStoragePermission.launch(Manifest.permission.READ_EXTERNAL_STORAGE)
        ...
        // Set an onClickListener for the image save button to handle gallery permission and saving the photo
...
//            Intent(Intent.ACTION_PICK, MediaStore.Images.Media.INTERNAL_CONTENT_URI)
                ...
                override fun onResourceReady(resource: Bitmap, transition: Transition<in Bitmap>?) {
                    ...
                    faceDetectorEngine.detectInImage(inputImage)
                        .addOnSuccessListener { faces ->
                            ...
                            if ((selectedTab == face1Tab && !face1Done) || (selectedTab == face2Tab && !face2Done)) {
                                Toast.makeText(requireActivity(), "Invalid image. No human face detected!", Toast.LENGTH_LONG).show()
                            }
    ...
    companion object {
        ...
        private const val GALLERY_REQUEST_CODE = 1006
    }
